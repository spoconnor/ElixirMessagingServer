sudo docker run --name worldserver -h worldserver -i -t -v /mnt/archive/Programming/Cloud/ElixirMessagingServer/DotNet/WorldServer:/opt/WorldServer mono:4.2.1.102 bash

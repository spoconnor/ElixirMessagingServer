...
SAY_FROM_FIELD.label = 1
SAY_FROM_FIELD.has_default_value = false
SAY_FROM_FIELD.default_value = ""
SAY_FROM_FIELD.type = 9
SAY_FROM_FIELD.cpp_type = 9
...
SAY_TARGET_FIELD.default_value = ""
SAY_TARGET_FIELD.type = 9
SAY_TARGET_FIELD.cpp_type = 9

...
local MAPREQUEST_MAPCHUNKX_FIELD = protobuf.FieldDescriptor();
local MAPREQUEST_MAPCHUNKY_FIELD = protobuf.FieldDescriptor();
local MAPIGNORE = protobuf.Descriptor();
local MAPIGNORE_MAPCHUNKX_FIELD = protobuf.FieldDescriptor();
local MAPIGNORE_MAPCHUNKY_FIELD = protobuf.FieldDescriptor();
...
MSGTYPE.values = {MSGTYPE_ERESPONSE_ENUM,MSGTYPE_EPING_ENUM,MSGTYPE_EPONG_ENUM,MSGTYPE_ENEWUSER_ENUM,MSGTYPE_ELOGIN_ENUM,MSGTYPE_ESAY_ENUM,MSGTYPE_EMAPREQUEST_ENUM,MSGTYPE_EMAPIGNORE_ENUM,MSGTYPE_EMAP_ENUM,MSGTYPE_EQUERYSERVER_ENUM,MSGTYPE_EQUERYSERVERRESPONSE_ENUM}
...
MESSAGE.enum_types = {}
MESSAGE.fields = {MESSAGE_MSGTYPE_FIELD, MESSAGE_FROM_FIELD, MESSAGE_DEST_FIELD, MESSAGE_RESPONSE_FIELD, MESSAGE_PING_FIELD, MESSAGE_PONG_FIELD, MESSAGE_NEWUSER_FIELD, MESSAGE_LOGIN_FIELD, MESSAGE_SAY_FIELD, MESSAGE_MAPREQUEST_FIELD, MESSAGE_MAPIGNORE_FIELD, MESSAGE_MAP_FIELD, MESSAGE_QUERYSERVER_FIELD, MESSAGE_QUERYSERVERRESPONSE_FIELD}
...
SAY.extensions = {}
MAPREQUEST_MAPCHUNKX_FIELD.name = "mapChunkX"
MAPREQUEST_MAPCHUNKX_FIELD.full_name = ".CommsMessages.MapRequest.mapChunkX"
MAPREQUEST_MAPCHUNKX_FIELD.number = 1
MAPREQUEST_MAPCHUNKX_FIELD.index = 0
MAPREQUEST_MAPCHUNKX_FIELD.label = 2
MAPREQUEST_MAPCHUNKX_FIELD.has_default_value = false
MAPREQUEST_MAPCHUNKX_FIELD.default_value = 0
MAPREQUEST_MAPCHUNKX_FIELD.type = 5
MAPREQUEST_MAPCHUNKX_FIELD.cpp_type = 1

MAPREQUEST_MAPCHUNKY_FIELD.name = "mapChunkY"
MAPREQUEST_MAPCHUNKY_FIELD.full_name = ".CommsMessages.MapRequest.mapChunkY"
MAPREQUEST_MAPCHUNKY_FIELD.number = 2
MAPREQUEST_MAPCHUNKY_FIELD.index = 1
MAPREQUEST_MAPCHUNKY_FIELD.label = 2
MAPREQUEST_MAPCHUNKY_FIELD.has_default_value = false
MAPREQUEST_MAPCHUNKY_FIELD.default_value = 0
MAPREQUEST_MAPCHUNKY_FIELD.type = 5
MAPREQUEST_MAPCHUNKY_FIELD.cpp_type = 1

MAPREQUEST.name = "MapRequest"
MAPREQUEST.full_name = ".CommsMessages.MapRequest"
MAPREQUEST.nested_types = {}
MAPREQUEST.enum_types = {}
MAPREQUEST.fields = {MAPREQUEST_MAPCHUNKX_FIELD, MAPREQUEST_MAPCHUNKY_FIELD}
MAPREQUEST.is_extendable = false
MAPREQUEST.extensions = {}
MAPIGNORE_MAPCHUNKX_FIELD.name = "mapChunkX"
MAPIGNORE_MAPCHUNKX_FIELD.full_name = ".CommsMessages.MapIgnore.mapChunkX"
MAPIGNORE_MAPCHUNKX_FIELD.number = 1
MAPIGNORE_MAPCHUNKX_FIELD.index = 0
MAPIGNORE_MAPCHUNKX_FIELD.label = 2
MAPIGNORE_MAPCHUNKX_FIELD.has_default_value = false
MAPIGNORE_MAPCHUNKX_FIELD.default_value = 0
MAPIGNORE_MAPCHUNKX_FIELD.type = 5
MAPIGNORE_MAPCHUNKX_FIELD.cpp_type = 1

MAPIGNORE_MAPCHUNKY_FIELD.name = "mapChunkY"
MAPIGNORE_MAPCHUNKY_FIELD.full_name = ".CommsMessages.MapIgnore.mapChunkY"
MAPIGNORE_MAPCHUNKY_FIELD.number = 2
MAPIGNORE_MAPCHUNKY_FIELD.index = 1
MAPIGNORE_MAPCHUNKY_FIELD.label = 2
MAPIGNORE_MAPCHUNKY_FIELD.has_default_value = false
MAPIGNORE_MAPCHUNKY_FIELD.default_value = 0
MAPIGNORE_MAPCHUNKY_FIELD.type = 5
MAPIGNORE_MAPCHUNKY_FIELD.cpp_type = 1

MAPIGNORE.name = "MapIgnore"
MAPIGNORE.full_name = ".CommsMessages.MapIgnore"
MAPIGNORE.nested_types = {}
MAPIGNORE.enum_types = {}
MAPIGNORE.fields = {MAPIGNORE_MAPCHUNKX_FIELD, MAPIGNORE_MAPCHUNKY_FIELD}
